...
the 3-bit \texttt{pulses} mode bus and the packed 32-bit \texttt{ann\_address}
...
\texttt{PULSE\_NUM\_READ}  & 1 & Number of READ bursts per operation. \\
\texttt{PULSE\_NUM\_PROG}  & 1 & Number of PROGRAM bursts per operation. \\
\texttt{PULSE\_NUM\_ERASE} & 1 & Number of ERASE bursts per operation. \\
\texttt{PULSE\_NUM\_INF}   & 1 & Number of INFERENCE bursts per operation. \\
...
\texttt{ann\_address}   & Out & 32 & Packed bus: [31:24] data byte, [23:0] one-hot \{PE,SA,col,row\}. \\
