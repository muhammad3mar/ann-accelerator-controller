...
For **batch** (non-wave) top-level testbenches, see [Regular Testbench Runbook](REGULAR_TESTBENCH_RUNBOOK.md).
...
- **Run (wave):** `python scripts/run_sim.py sim -m Controller -tb controller_prog_verify_lut_tb_waves_tb --do-file tb/Controller/do/waves/controller_prog_verify_lut_tb_waves.do`
...
- **Compile:** `python scripts/run_sim.py compile -m Controller -t verif`
- **Run (wave):** `python scripts/run_sim.py sim -m Controller -tb controller_prog_verify_lut_10w_tb_waves_tb --do-file tb/Controller/do/waves/controller_prog_verify_lut_10w_tb_waves.do`

### `parallel_interface_controller_integration_tb_waves_tb`
- **Tests:** Integration of PI + controller + input buffer paths.
- **Compile:** `python scripts/run_sim.py compile -m Controller -t verif`
- **Run (wave):** `python scripts/run_sim.py sim -m Controller -tb parallel_interface_controller_integration_tb_waves_tb --do-file tb/Controller/do/waves/parallel_interface_controller_integration_tb_waves.do`
...
- **Compile:** `python scripts/run_sim.py compile -m Controller -t verif`
- **Run (wave):** `python scripts/run_sim.py sim -m Controller -tb controller_host_erase_tb_waves_tb --do-file tb/Controller/do/waves/controller_host_erase_tb_waves.do`
...
- **Compile:** `python scripts/run_sim.py compile -m Controller -t verif`
- **Run (wave):** `python scripts/run_sim.py sim -m Controller -tb controller_inf_buffer_flow_tb_waves_tb --do-file tb/Controller/do/waves/controller_inf_buffer_flow_tb_waves.do`
...
- **Run (wave):** `python scripts/run_sim.py sim -m Input_Buffer -tb input_buffer_bit_serial_tb_waves_tb --do-file tb/Input_Buffer/do/waves/input_buffer_bit_serial_tb_waves.do`
...
- **Compile:** `python scripts/run_sim.py compile -m Input_Buffer -t verif`
- **Run (wave):** `python scripts/run_sim.py sim -m Input_Buffer -tb input_buffer_reset_behavior_tb_waves_tb --do-file tb/Input_Buffer/do/waves/input_buffer_reset_behavior_tb_waves.do`
