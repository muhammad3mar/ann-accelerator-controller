//------------------------------------------------------------------------------
// Controller Program-Verify Cycle Testbench (USE_WEIGHT_PULSE_LUT)
//------------------------------------------------------------------------------
// Same as controller_prog_verify_tb but DUT uses weight_pulse_lut.mem for PROG_WRITE.
// Tests and verifies:
...
module controller_prog_verify_lut_tb;
    ...
    localparam string REPORT_FILE  = "target/Controller/prog_verify_lut_report.txt";
    ...
    ann_controller #(
        ...
        .WEIGHT_PULSE_LUT_FILE("target/Controller/weight_pulse_lut.mem")
    ) dut (
    ...
    initial begin
        ...
        $fdisplay(fd, "//------------------------------------------------------------------------------");
        $fdisplay(fd, "// Controller Program-Verify Cycle Verification Report (LUT program pulses)");
        $fdisplay(fd, "//------------------------------------------------------------------------------");
