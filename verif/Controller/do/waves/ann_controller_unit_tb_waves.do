# TB + ann_controller only (no duplicate hierarchy for buffer nets)

onerror { resume }
quietly WaveActivateNextPane {} 0

set TB /ann_controller_unit_tb_waves_tb/u_tb
...
add wave -noupdate $TB/weight_read_data
add wave -noupdate $TB/write_en_bfm
add wave -noupdate $TB/read_en_bfm
